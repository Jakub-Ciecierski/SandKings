...
public class mainClass {
	public static void main(String[] args) {
		...
		bitches.addInfluence(moneys, 0.5);				// Relation 1
		fucks.addInfluence(moneys, 0.8);				// Relation 2
		fucks.addInfluence(bitches, 0.9);				// Relation 3
		bitches.addInfluence(timeWithBitches, -0.6);	// Relation 4
