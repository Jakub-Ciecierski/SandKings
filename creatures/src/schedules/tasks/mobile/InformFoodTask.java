...
public class InformFoodTask extends Task {
	...
	public InformFoodTask (Information information, Mobile mobile) {
		...
		//SmartConsole.Print("Agent #" + mobile.getID() +" New InfoFood # " + information.getAgent().getID(), DebugModes.ADVANCED);
	}
	...
	public void execute() {
			...
			currPoint.getY() == destPoint.getY() && stage == 0)
		{
			...
			//SmartConsole.Print("Agent "+ mobile.getID() +" informed mother Food #" + information.getAgent().getID(), DebugModes.ADVANCED);			
		}
	}
